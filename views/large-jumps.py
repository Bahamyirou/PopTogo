...
st.markdown(
    """
        ...
        | `LatestSampleValue`       | The measure value that was the latest collected value in that site for this pathogenes          |
        | `LatestSampleDate`        | The date associated with the LatestObservationValue. Last time data was collected in that site  |
